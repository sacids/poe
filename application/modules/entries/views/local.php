                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form id="regForm" action="<?= site_url('entries/local') ?>" method="post">
                                ...
                                <?php echo form_hidden('form_type', 'Local'); ?>
                                ...
                                <div class="tab" id="tab2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                <label><?= $this->lang->line('lbl_region') ?> <span style="color: red;">*</span></label>
                                                <?php
                                                $region_option = [];
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                <label><?= $this->lang->line('lbl_mobile') ?> <span style="color: red;">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                echo form_dropdown('region_origin', $_options, set_value('region_origin'), 'class="form-control" id="region_origin"'); ?>
